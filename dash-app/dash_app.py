...
text_color = "#495057"
hover_color = "#e9ecef"
active_bg_color = "#7f8996"        # active background color
active_text_color = "white"        # active text color
clicked_color = "#bac3cc"          # custom color on click

# Sidebar with logo image instead of icons
logo_path = '/assets/sea-level.png'  # your main logo

def navlink_with_logo(text, href, id_, active=False):
    return dbc.NavLink(
        [
...
sidebar = html.Div(
    [
        html.Div(
            html.Img(src=logo_path, style={'width': '80px', 'marginBottom': '1rem', 'alignSelf': 'center'}),
            style={'textAlign': 'center'}
        ),
        navlink_with_logo("Home", "#home", "home-link", active=True),
        navlink_with_logo("Dados", "#dados", "dados-link"),
        navlink_with_logo("Modelos", "#modelos", "modelos-link"),
        navlink_with_logo("Configurações", "#config", "config-link"),
        html.Div(
